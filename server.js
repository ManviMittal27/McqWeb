...
mongoose
  .connect(
    "mongodb+srv://manvi5032be21:manvi5032be21@cluster0.2nypt0n.mongodb.net/?retryWrites=true&w=majority",
    {
...
app.post("/logout", (req, res) => {
  try {
    // Clear any session data or tokens associated with the user's authentication
    // For example, if using JWT, you can simply clear the token from the client-side storage
